...
insert into users_perfis (usuario_username, perfis_id) values ('andre',1);
insert into users_perfis (usuario_username, perfis_id) values ('kenyo',1);
